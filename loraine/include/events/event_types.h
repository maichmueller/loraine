...
//
//class IAllEventSubscriber:
//    public IEventSubscriber< std::decay_t< decltype(helpers::make_event_interface(
//       std::declval< std::make_index_sequence< events::n_events > >())) > > {
//};
//
//class LOREvent {
...
//      return std::get< DetailType >(m_event_detail);
//   }
//   [[nodiscard]] inline void trigger(EventBus& bus, GameState& state)
//   {
//      std::visit(
//         [&](auto& event) {
